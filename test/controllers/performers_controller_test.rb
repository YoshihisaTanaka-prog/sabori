...
class PerformersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create performer" do
    assert_difference('Performer.count') do
      post performers_url, params: { performer: { event_id: @performer.event_id, firstname: @performer.firstname, lastname: @performer.lastname, organization: @performer.organization, role: @performer.role } }
    end
  ...
  test "should update performer" do
    patch performer_url(@performer), params: { performer: { event_id: @performer.event_id, firstname: @performer.firstname, lastname: @performer.lastname, organization: @performer.organization, role: @performer.role } }
